...
import 'package:volta_quiz/services/notification/notification_service.dart';
...
extension QuizeResult on QuizController {
  ...
  String get correctAnsweredQuestions {
    return '$correctQuestionCount de ${allQuestions.length} son correctas';
  }
  ...
  Future<void> saveQuizResults() async {
    ...
    Get.find<NotificationService>().showQuizCompletedNotification(
        ...
        body:
            'Recibiste $points puntos por ${quizPaperModel.title} -  Toca para ver la tabla de clasificación',
