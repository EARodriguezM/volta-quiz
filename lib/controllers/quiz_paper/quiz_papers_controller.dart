...
import 'package:volta_quiz/models/models.dart' show QuizPaperModel;
import 'package:volta_quiz/screens/screens.dart' show QuizeScreen;
  ...
  Future<void> getAllPapers() async {
    try {
      ...
      for (var paper in paperList) {
        final imageUrl =
            await Get.find<FireBaseStorageService>().getImage(paper.id);
