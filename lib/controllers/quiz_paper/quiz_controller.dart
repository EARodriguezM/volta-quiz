...
import 'package:volta_quiz/controllers/auth_controller.dart';
import 'package:volta_quiz/firebase/firebase_configs.dart';
import 'package:volta_quiz/models/models.dart';
import 'package:volta_quiz/screens/screens.dart';
import 'package:volta_quiz/services/firebase/firebasestorage_service.dart';
import 'package:volta_quiz/utils/logger.dart';
import 'package:volta_quiz/widgets/dialogs/dialogs.dart';
...
class QuizController extends GetxController {
  ...
  void loadData(QuizPaperModel quizPaper) async {
    ...
    try {
      ...
      for (Question _question in quizPaper.questions!) {
        ...
        final imageUrl =
            await Get.find<FireBaseStorageService>().getImage(_question.id);
        _question.imageUrl = imageUrl;
      }
    ...
    //     final imageUrl =
    //         await Get.find<FireBaseStorageService>().getImage(question.id);
  ...
  String get completedQuiz {
    final answeredQuestionCount = allQuestions
        ...
        .toList()
        .length;
    return '$answeredQuestionCount de ${allQuestions.length} respondidas';
  }
